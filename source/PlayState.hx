	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			default:
			{
					defaultCamZoom = 0.7;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-600, -600).loadGraphic(Paths.image('courtwall'));
					bg.antialiasing = true;
					bg.scrollFactor.set(1, 1);
					bg.active = false;
					add(bg);

					var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('courtground'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
		...
		gf = new Character(300, 130, gfVersion);
